import { ClipboardText, GridNine, SignOut, User } from '@phosphor-icons/react';
                ...
                <nav className="-mx-3 space-y-6">
                    <div className="space-y-3">
                        ...
                        <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer">
                            ...
                            <span className="mx-2 text-sm font-medium" onClick={() => navigate('/adminprofile/:name')}>Usuario</span>
                        </a>
                    </div>
                    ...
                    <div className="space-y-3 ">
                        ...
                        <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer">
                            ...
                            <span className="mx-2 text-sm font-medium" onClick={() => navigate('/dashboard')}>Dashboard</span>
                        </a>
                    </div>
                    ...
                    <div className="space-y-3 ">
                        ...
                        <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer">
                            ...
                            <span className="mx-2 text-sm font-medium" onClick={() => navigate('/adminprofile/reservas')}>Reservas</span>
                        </a>
                    </div>
