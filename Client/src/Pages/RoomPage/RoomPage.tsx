...
const RoomPage = () => {
  ...
  {roomRender ? (
    <div className="border-4 border-blue-500 bg-white p-20 min-h-screen flex justify-end items-center">
              ...
              <div className="bg-gray-200 p-4 rounded shadow-lg border border-black mt-5">
                <div className="mb-4">
                  ...
                  {roomRender?.services.map((service: any) => (
                    <div key={service} className="flex items-center text-lg text-gray-800">
                ...
                <div className="flex">
                  ...
                  <button
                    onClick={() => navigate(`/hotelpage/${roomRender?.hotelId}`)}
                ...
                <p className="text-gray-800 mt-4">{roomRender?.description}</p>
              </div>
            </div>
          )}
        </div>
      ...
      <button onClick={() => navigate(-1)} className="bg-blue-500 font-bold w-[80px] border-black rounded mt-8">
        Back
      </button>
    </div>
  ) : (
